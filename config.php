...
define('API_AUTH_KEY', '3658bdf4565e3dab6a6dd6998cddf146cd847badc8a47fb32fccf40711e66af8');
define('BUSINESS_ID', 3);
define('IMGS_DIR', __DIR__ . '/imgs');

// API Endpoints
define('API_BASE_URL', 'https://dev.montexsoft.com/api/qrmenu');
